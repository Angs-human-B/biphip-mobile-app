          ...
          child: Obx(
            () => Column(
              ...
              children: [
                ...
                //     var customUserName;
                //     for (int i = 0; i < selfieController.customPeopleNames.length; i++) {
                //       customUserName = selfieController.customPeopleNames[i];
                //     }
                //     return Obx(
                //       () => Padding(
                ...
                //           // subtitle: Text(customUserName.toString()),
                ...
                //             if (selfieController.temporarySelectedPrivacyId.value == 5) {
                //               Get.toNamed(krSelectPeoplePage);
                //               await Get.find<FriendController>().getFriendList();
                //               for (int i = 0; i < Get.find<FriendController>().friendList.length; i++) {
                //                 selfieController.isCustomPeopleSelected.add(false);
                //               }
                //               // ll(selfieController.isCustomPeopleSelected);
                //             }
                //           },
                //           trailing: CustomRadioButton(
                //             onChanged: () async {
