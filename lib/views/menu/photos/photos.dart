                        ...
                        (context, index) {
                          ...
                          return InkWell(
                            onTap: () async {
                              ...
                              // ll(albumIndex);
                              Get.to(() =>
                                  GalleryWidget(urlImages: RxList(galleryController.imageDataList[albumIndex].imageList), imageIndex: index, postIndex: albumIndex));
                            },
                            child: Container(
...
//   final GalleryController postReactionController = Get.find<PostReactionController>();
//   final AlbumListModel photoData;
