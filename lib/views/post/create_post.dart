    ...
    return PopScope(
      ...
      onPopInvoked: ((didPop) {
        if (didPop) {
          ...
          if (createPostController.createPostTextEditingController.text != "" || createPostController.allMediaList.isNotEmpty) {
            createPostHelper.editPostAlertDialog(context: context);
          } else {
            Get.back();
          }
        }
                                            ...
                                            globalController.commonBottomSheet(
                                                ...
                                                onPressRightButton: () {
                                                  ...
                                                  createPostController.selectedProductCategoryID.value =
                                                      createPostController.tempSelectedProductCategoryID.value;
                                                  createPostHelper.checkCanCreatePost();
                                                  Get.back();
                                                },
                                                rightText: ksDone.tr,
