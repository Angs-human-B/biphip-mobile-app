                      ...
                      () => Column(
                        children: [
                          ...
                          TapAbleButtonContainer(
                            buttonText:
                                dashboardController.payoutsTapButtonText,
                            buttonState:
                                dashboardController.payoutsTapButtonState,
                            buttonPress: RxList([
                              () {
                                dashboardController
                                    .payoutsOverviewTapableButtonOnPressed();
                              },
                              () async {
                                dashboardController
                                    .payoutsTransectionsTapableButtonOnPressed();
                              },
                              () {
                                dashboardController
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        DashboardCommonContainer(
                                          ...
                                          totalValue:
                                              "\$${dashboardController.dashboardPayoutEarningInsightData.value?.totalEarning.toString()}",
                                        ...
                                        DashboardCommonContainer(
                                          ...
                                          totalValue:
                                              "\$${dashboardController.dashboardPayoutEarningInsightData.value?.totalWithdraw.toString()}",
                                        ),
                                      ],
                                    ),
                                    kH20sizedBox,
                                    dashboardController
                                            .isEarningReportAvailable.value
                                        ? Container(
                                            width: width - 40,
                                            decoration: BoxDecoration(
                                              color: cWhiteColor,
                                              border: Border.all(
                                                  width: 1, color: cLineColor),
                                              borderRadius:
                                            ...
                                            child: Padding(
                                              ...
                                              child: StarGiftReport(
                                                ...
                                                apiData: dashboardController
                                                    .dashboardPayoutEarningInsightData
                                                    .value!
                                                    .earningReport!,
                                                containerRightText:
                                                    "\$${dashboardController.dashboardPayoutEarningInsightData.value?.totalEarning.toString()}",
                                    ...
                                    kH16sizedBox,
                                    dashboardController
                                            .isWithdrawReportAvailable.value
                                        ...
                                        : EmptyViewContainer(
                                            ...
                                            titleTextStyle: semiBold16TextStyle(
                                                cBlackColor),
                                          ),
                                  ],
                                ),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Obx(() => PayoutTransectionTopContainer(
                                          ...
                                          amount: "\$370",
                                          buttonText: dashboardController
                                                  .withdrawHistoryList.isEmpty
                                              ? ksVerify.tr
                                              : ksWithdraw.tr,
                                          buttonOnPressed: () {
                                            dashboardController
                                                .payoutWithdrawTextEditingController
                                                .clear();
                                            dashboardController
                                                .isdashboardPayoutWithdraw
                                                .value = false;
                                            Get.toNamed(
                                                krDshboardPayoutWithdraw);
                                          },
                                        )),
                                    kH16sizedBox,
                                                              ...
                                                              padding:
                                                                  const EdgeInsets
                                                                      ...
                                                                      left:
                                                                          k8Padding),
                                                              child: Text(
                                                                  "\$${dashboardController.withdrawHistoryList[index]["availableAmount"]}",
                          ...
                          if (dashboardController.payoutsTapButtonState[2])
                            SizedBox(
                              ...
                              child: SingleChildScrollView(
                                child: Padding(
                                  padding:
                                      const EdgeInsets.only(top: k20Padding),
                                  child: Column(
                                    children: [
                                      dashboardController
                                              .payoutBankAccountList.isEmpty
                                          ? DashboardPayoutSettingCommonContainer(
                                              prefixIcon: BipHip.add_1,
                                              titleText:
                                                  "$ksNoBankAccountInformationAddedYet!",
                                              buttonOnPressed: () {
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        dashboardController.payoutBankAccountList[index]
                                                                            [
                                                                            "accountName"],
                                                              ...
                                                              .commonBottomSheet(
                                                                  ...
                                                                  bottomSheetHeight: isDeviceScreenLarge()
                                                                      ...
                                                                      : height *
                                                                          0.7,
                                                                  content:
                                                                      const AddPayoutMethodBottomSheetContent(),
                                                                  onPressCloseButton:
                                                                      () {
                                                                    Get.back();
                                                                  },
                                      ...
                                      kH16sizedBox,
                                      dashboardController
                                                  .payoutTaxInformationStatus
                                                  .value ==
                                              ""
                                          ? DashboardPayoutSettingCommonContainer(
                                              prefixIcon: BipHip.add_1,
                                              titleText:
                                                  "$ksNoTaxInformationAddedYet!",
                                              buttonOnPressed: () {
    ...
    ? "Submitted on ${DateFormat("dd MMM, yyyy").format(dashboardController.dashboardUserIdentificationData.first!.updatedAt!)}."
        : "Submission date not available.",
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsets.all(k16Padding),
                                          child: Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
...
class PayoutTransectionTopContainer extends StatelessWidget {
  const PayoutTransectionTopContainer(
      {super.key,
      this.title,
      this.amount,
      this.buttonText,
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(
                left: k20Padding, right: k20Padding, top: k4Padding),
            child: Text(
...
class EmptyViewContainer extends StatelessWidget {
  const EmptyViewContainer(
      {super.key, required this.titleText, this.titleTextStyle});
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              height: 4,
                              decoration: const BoxDecoration(
                                  color: cIconColor, shape: BoxShape.circle),
                            ),
                            kW4sizedBox,
                            Expanded(
                              child: Text(
...
class DashboardPayoutSettingCommonContainer extends StatelessWidget {
  const DashboardPayoutSettingCommonContainer(
      {super.key,
