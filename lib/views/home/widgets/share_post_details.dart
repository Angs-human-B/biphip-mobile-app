                                                              ...
                                                              child: InkWell(
                                                                onTap: () {
                                                                  Get.find<GlobalController>().commonBottomSheet(
                                                                      ...
                                                                      bottomSheetHeight:
                                                                          homeController.postData.value!.post.taggedFriends.length > 10 ? height * 0.6 : null,
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child: Image.network(
                                                              ...
                                                              color:
                                                                  homeController.postData.value!.post.images.length > 5 ? cBlackColor.withOpacity(0.3) : null,
                                                              colorBlendMode: homeController.postData.value!.post.images.length > 5 ? BlendMode.multiply : null,
                                                              fit: BoxFit.cover,
                                                              errorBuilder: (context, error, stackTrace) => const Icon(
                                                                BipHip.imageFile,
                                                                size: kIconSize120,
                                          ...
                                          return Obx(() => Column(
                                                ...
                                                children: [
                                                      ...
                                                      child: Align(
                                                          ...
                                                          child: InkWell(
                                                              onTap: () async {
                                                                ...
                                                                await homeController.getPostReplyList(homeController.postData.value!.post.comments[i].id!, i);
                                                              },
                                                              child: Text(
                                                                "View Replies",
                                                  ...
                                                  if (homeController.postReplyShow[i])
                                                    for (int index = 0; index < homeController.postData.value!.post.comments[i].commentReplies.length; index++)
                                                      Padding(
