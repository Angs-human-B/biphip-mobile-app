...
const String ksKidNameLengthErrorText = "Kid name must be 3 character";
...
const String ksEnterKidParentEmail = "Enter kid parent email";
const String ksEnterKidParentPhone = "Enter kid parent phone";
const String ksEnterKidParentAddress = "Enter kid parent address";
const String ksEnterKidBio = "Enter kid bio";
