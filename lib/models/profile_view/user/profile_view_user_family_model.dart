...
class ProfileViewUserFamilyModel {
    Families? families;

    ProfileViewUserFamilyModel({
        this.families,
    });

    factory ProfileViewUserFamilyModel.fromJson(Map<String, dynamic> json) => ProfileViewUserFamilyModel(
